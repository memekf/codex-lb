...
async def test_backend_files_create_forwards_payload_and_returns_upstream_json(async_client, monkeypatch):
    ...
    async def fake_create_file(
        *, payload, headers, access_token, account_id, local_account_id=None, base_url=None, session=None
    ):
...
async def test_backend_files_finalize_returns_upstream_payload(async_client, monkeypatch):
    ...
    async def fake_finalize_file(
        *, file_id, headers, access_token, account_id, local_account_id=None, base_url=None, session=None
    ):
